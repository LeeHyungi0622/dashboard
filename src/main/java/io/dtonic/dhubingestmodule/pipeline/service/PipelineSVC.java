...
public class PipelineSVC {
    ...
    public PipelineResponseVO getPipelineDraftsList() {
        PipelineResponseVO pipelineVO = pipelineMapper.getPipelineDraftsList();
        return pipelineVO;
    }

    public PipelineResponseVO getPipelineDraftsVOById(Integer id) {
        PipelineResponseVO pipelineVO = pipelineMapper.getPipelineDraftsById(id);
        return pipelineVO;
    }
