...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  private static final String CHAUT = "chaut";
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      if (jwt != null && isValidSession(request, response)) {
        ...
        String loginUri = ingestManagerSVC.getLoginUri(request);
      ...
      if (ingestManagerSVC.getRefreshToken(request, response)) {
        ...
        entryPoint.commence(
          request,
          response,
          new JwtExpiredException("JWT Expired.", e)
        );
      }
      ...
      entryPoint.commence(
        request,
        response,
        new JwtAuthentioncationException("Authn Fail.", e)
      );
    } catch (Exception e) {
   ...
   */
  private Claims getClaimsJws(String jwt, PublicKey publicKey)
    throws Exception {
  ...
  private PublicKey getPublickey(String jwt) throws Exception {
    ...
    try {
      ResponseEntity<String> result = ingestManagerSVC.getPublicKey(jwt);
